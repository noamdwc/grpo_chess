...
| WandB Plots | User-provided screenshots showing eval trends with ~13 data points (API sampling missed most eval-only steps) |
...
5. Examined user-provided WandB plots for eval data (API sampling at 500 points missed most eval data points)
